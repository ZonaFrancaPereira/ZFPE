        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td bgcolor="#ffffff" style="background-color:#ffffff;padding:32px;color:#22404b;">
              <h2 style="margin:0 0 16px;color:#22404b;">Nuevo comité programado</h2>
              <p style="margin:0 0 20px;color:#333;line-height:1.5;">
                Hola<?= !empty($nombreDestinatario) ? ' ' . htmlspecialchars($nombreDestinatario) : '' ?>, se programó un nuevo comité en el
                <strong>Centro de Control Gerencial — Zona Franca Internacional de Pereira</strong> para la empresa
              ...
              <table role="presentation" width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;margin-bottom:20px;">
                <tr>
                  <td bgcolor="#f8fafb" style="border:1px solid #e2e6e8;background-color:#f8fafb;width:40%;color:#22404b;"><strong>Título</strong></td>
                  <td bgcolor="#ffffff" style="border:1px solid #e2e6e8;background-color:#ffffff;color:#333;"><?= htmlspecialchars($titulo) ?></td>
                </tr>
                <tr>
                  <td bgcolor="#f8fafb" style="border:1px solid #e2e6e8;background-color:#f8fafb;color:#22404b;"><strong>Tipo</strong></td>
                  <td bgcolor="#ffffff" style="border:1px solid #e2e6e8;background-color:#ffffff;color:#333;"><?= htmlspecialchars($tipoLabel) ?></td>
                </tr>
                <tr>
                  <td bgcolor="#f8fafb" style="border:1px solid #e2e6e8;background-color:#f8fafb;color:#22404b;"><strong>Fecha</strong></td>
                  <td bgcolor="#ffffff" style="border:1px solid #e2e6e8;background-color:#ffffff;color:#333;"><?= htmlspecialchars($fechaFormateada) ?></td>
                </tr>
                <?php if (!empty($lugar)): ?>
                <tr>
                  <td bgcolor="#f8fafb" style="border:1px solid #e2e6e8;background-color:#f8fafb;color:#22404b;"><strong>Lugar</strong></td>
                  <td bgcolor="#ffffff" style="border:1px solid #e2e6e8;background-color:#ffffff;color:#333;"><?= htmlspecialchars($lugar) ?></td>
                </tr>
                <?php endif; ?>
              </table>
              ...
              <?php if (!empty($descripcion)): ?>
                <div style="background-color:#f0f8fb;border:1px solid #1993b8;border-radius:6px;padding:16px;margin-bottom:20px;">
                  <p style="margin:0 0 8px;color:#22404b;"><strong>Agenda / Descripción</strong></p>
                  <p style="margin:0;color:#333;white-space:pre-line;"><?= nl2br(htmlspecialchars($descripcion)) ?></p>
                </div>
              <?php endif; ?>
